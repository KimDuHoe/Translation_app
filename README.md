...
```
배경 : 기존 청각 장애인은 음성 보조앱을 이용할 때, 출력된 자막만으로는 상대방의 감정과 의도를 구분하는 점에 오해가 생김.
       해당 문제를 해결하기 위함.
```
...
```
  들리는 목소리를 기반으로 화자를 구분해주는 탭공간입니다. (화자의 감정 상태를 보여준다. <- 본 기능)
```

--------------------------------------

+ 대화요약<br/>
<img width="1080" height="2340" alt="KakaoTalk_20260420_152438789_03" src="https://github.com/user-attachments/assets/acec0ac4-1dd2-47b9-94e8-efd4bca5670d" />
<br/>
...
+ 감정상태<br/>
<img width="1080" height="2340" alt="KakaoTalk_20260420_152438789_07" src="https://github.com/user-attachments/assets/7535ef4d-4494-4413-9a7c-6a39e39f76a8" />
